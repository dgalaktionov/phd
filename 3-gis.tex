...
\chapter{Previous concepts}
    ...
    In this section we will present two well known models used to represent geographical information, although we will not cover how the most used operations are implemented using these models or how the precision problems may be addressed. Refer to \cite{bolstad2016gis} for a more in-depth coverage on those topics.
