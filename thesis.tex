...
\chapter{Previous concepts}
    ...
    Therefore, the \gls{csa} is formed by $\Psi$, $D$, and $V$, which are sufficient to simulate binary searches of the interval $A[l,r]$ for the occurrences of $P$ without the need of accessing $A$ nor $S$. 
